...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#ip_reputation
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/block-malicious-actor-ip-reputation.html
tags:
    - demo
    - ip_reputation
    - lists
...
from cyb3rhq_testing.modules import TIER0, LINUX, WINDOWS
