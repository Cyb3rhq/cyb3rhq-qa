...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#osquery
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/integrate-osquery.html
    - https://documentation.cyb3rhq.com/current/user-manual/capabilities/osquery.html#osquery
