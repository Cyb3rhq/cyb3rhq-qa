...
brief: This test will verify that the integeration with Virustotal works correctly. Syscheck scans a directory for
       changes and make the cyb3rhq-integratord component query VirusTotal for threat results using the VirusTotal API.
       Once VirusTotal identifies a file as a threat, Cyb3rhq is configured to trigger an active response to remove the
...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#-virustotal
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/detect-remove-malware-virustotal.html
    - https://documentation.cyb3rhq.com/current/user-manual/capabilities/virustotal-scan/index.html#virustotal-scan
