...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#audit
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/audit-commands-run-by-user.html
    - https://documentation.cyb3rhq.com/current/learning-cyb3rhq/audit-commands.html#learning-cyb3rhq-audit-commands
