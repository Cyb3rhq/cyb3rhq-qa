...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#suricata
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/integrate-network-ids-suricata.html
    - https://documentation.cyb3rhq.com/current/learning-cyb3rhq/suricata.html#learning-cyb3rhq-suricata
tags:
    - demo
    - suricata
    - nids
