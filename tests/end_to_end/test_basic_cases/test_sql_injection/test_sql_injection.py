...
brief: This test will verify that a SQL injection attack is detected correctly. Cyb3rhq is able to detect an SQL Injection
...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#sql_injection
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/detect-web-attack-sql-injection.html
tags:
    - demo
    - sql_injection
'''
