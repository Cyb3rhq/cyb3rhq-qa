...
brief: This test will verify that the anomaly and malware detection works correctly. Anomaly detection refers to the
       ...
       techniques to accomplish this, Cyb3rhq uses a broad spectrum approach to finding anomalous patterns that indicate
       possible intruders.
...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#trojan
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/poc-detect-trojan.html
