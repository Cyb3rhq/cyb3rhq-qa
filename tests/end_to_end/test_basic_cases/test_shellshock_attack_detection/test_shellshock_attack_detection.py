...
references:
    - https://github.com/cyb3rhq/cyb3rhq-automation/wiki/Cyb3rhq-demo:-Execution-guide#shellshock
    - https://documentation.cyb3rhq.com/current/proof-of-concept-guide/detect-web-attack-shellshock.html
    - https://documentation.cyb3rhq.com/current/learning-cyb3rhq/shellshock.html#learning-cyb3rhq-shellshock
