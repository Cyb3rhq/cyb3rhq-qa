...
def validate_inventory(inventory_path, target_hosts):
    ...
    This function checks:
        ...
        2. If the hostnames follow our standard (<os>-<cyb3rhq-installation-type>)
    ...
    if missing_hosts != []:
        readme_file = '[README.md](https://github.com/cyb3rhq/cyb3rhq-qa/blob/master/tests/end_to_end/README.md)'
...
def get_indexer_credentials(request):
    """Get cyb3rhq-indexer username and password.

       Returns:
            dict: cyb3rhq-indexer credentials.
    """
