...
from cyb3rhq_testing.tools.file import validate_json_file, read_json_file, write_json_file, get_file_lines
...
def test_check_file_system_integrity(get_first_file, get_second_file, get_output_path):
    ...
    Example run:
        python3 -m pytest cyb3rhq-qa/tests/check_files/test_check_files/test_system_check_files.py
