...
agent_groups = {'cyb3rhq-agent1': ['default', 'test_mg_0'],
                'cyb3rhq-agent2': ['default', 'test_mg_1']}
test_infra_agents = ['cyb3rhq-agent1', 'cyb3rhq-agent2']

shared_folder_path = os.path.join(CYB3RHQ_PATH, 'etc', 'shared')
mg_folder_path = os.path.join(CYB3RHQ_PATH, 'var', 'multigroups')
