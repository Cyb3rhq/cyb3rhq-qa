...
def clone_cyb3rhq_repository(pytestconfig):
    """Fixture that clones a Cyb3rhq repository in a temporary directory and checkout to the branch given by parameter.
    ...
    """
    # Get Cyb3rhq repository and branch
    ...
    try:
        ...
        try:
            Repo.clone_from(f"https://github.com/cyb3rhq/{repository_name}.git",
                            repository_path,
                            depth=1,
                            branch=reference)
        except GitCommandError:
            repo = Repo.clone_from(f"https://github.com/cyb3rhq/{repository_name}.git",
