...
```
Parameters:
    --repo: repository name. Default: 'cyb3rhq'.
...
```
### Scanning cyb3rhq-qa requirements file:

> The script does not support pyenv version changes because it doesn't expect system variables to be modified

```
↪ ~/git/cyb3rhq-qa/tests/scans ⊶ feature/1612-package-vuln-scanner ⨘ python3 -m pytest -vv -x --disable-warnings dependencies/ --repo cyb3rhq-qa --reference master --requirements-path requirements.txt
==================================================================================== test session starts =====================================================================================
...
rootdir: /home/kondent/git/cyb3rhq-qa/tests/scans
...
pytestconfig = <_pytest.config.Config object at 0x7f721b4c4eb0>
    ...
    def test_python_dependencies_vuln_scan(pytestconfig):
        ...
        requirements_url = f'https://raw.githubusercontent.com/cyb3rhq/{repo}/{branch}/{requirements_path}'
...
>       assert loads(result)['vulnerabilities_found'] == 0, f'Vulnerables packages were found, full report at: ' \
                                                            f'{report_path}'
E       AssertionError: Vulnerables packages were found, full report at: /home/kondent/git/cyb3rhq-qa/tests/scans/dependencies/report_file.json
E       assert 28 == 0
E         +28
E         -0
...
FAILED dependencies/test_dependencies.py::test_python_dependencies_vuln_scan - AssertionError: Vulnerables packages were found, full report at: /home/kondent/git/cyb3rhq-qa/tests/scans/dependen...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! stopping after 1 failures !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
===================================================================================== 1 failed in 1.87s ======================================================================================
↪ ~/git/cyb3rhq-qa/tests/scans ⊶ feature/1612-package-vuln-scanner ⨘ cat dependencies/report_file.json
{
...
### Scanning cyb3rhq requirements file with a specific output path:
```
↪ ~/git/cyb3rhq-qa/tests/scans ⊶ feature/1612-package-vuln-scanner ⨘ python3 -m pytest -vv -x --disable-warnings dependencies/ --repo cyb3rhq --reference master --requirements-path framework/requirements.txt --report-path ~/Desktop/report_file.json
==================================================================================== test session starts =====================================================================================
platform linux -- Python 3.9.5, pytest-6.2.3, py-1.10.0, pluggy-0.13.1 -- /home/kondent/pythonEnv/qa-env/bin/python3
cachedir: .pytest_cache
metadata: {'Python': '3.9.5', 'Platform': 'Linux-5.11.0-34-generic-x86_64-with-glibc2.31', 'Packages': {'pytest': '6.2.3', 'py': '1.10.0', 'pluggy': '0.13.1'}, 'Plugins': {'html': '3.1.1', 'metadata': '1.11.0', 'testinfra': '5.0.0'}}
...
===================================================================================== 1 passed in 0.68s ======================================================================================
↪ ~/git/cyb3rhq-qa/tests/scans ⊶ feature/1612-package-vuln-scanner ⨘ cat ~/Desktop/report_file.json
{
