...
references:
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/gcp-pubsub.html#max-messages
...
from cyb3rhq_testing.gcloud import callback_detect_start_fetching_logs, callback_received_messages_number
...
def test_max_messages(get_configuration, configure_environment, reset_ossec_log, publish_messages,
    ...
    cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout + time_interval,
                            callback=callback_detect_start_fetching_logs,
                            error_message='Did not receive expected '
                                          '"Starting fetching of logs" event')

    numbers_pulled = cyb3rhq_log_monitor.start(timeout=pull_messages_timeout,
