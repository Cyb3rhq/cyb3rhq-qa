...
references:
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/gcp-pubsub.html#interval
...
from cyb3rhq_testing.gcloud import callback_detect_start_fetching_logs, callback_detect_start_gcp_sleep
