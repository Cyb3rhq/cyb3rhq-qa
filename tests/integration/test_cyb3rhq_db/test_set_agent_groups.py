...
from cyb3rhq_testing.cyb3rhq_db import query_wdb, insert_agent_in_db
...
def test_set_agent_groups(remove_database, restart_cyb3rhq_daemon, test_case, create_groups):
    '''
    description: Check that every input message using the 'set_agent_groups' command in cyb3rhq-db socket generates
                 the proper output to cyb3rhq-db socket. To do this, it performs a query to the socket with a command
    ...
    parameters:
        ...
        - restart_cyb3rhq:
            type: fixture
            brief: Reset the 'ossec.log' file and restart Cyb3rhq.
        - test_case:
            type: fixture
