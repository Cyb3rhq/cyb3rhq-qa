...
from cyb3rhq_testing.cyb3rhq_db import query_wdb, insert_agent_into_group, clean_agents_from_db
from cyb3rhq_testing.cyb3rhq_db import clean_groups_from_db, clean_belongs, calculate_global_hash
from cyb3rhq_testing.modules import TIER0, SERVER, LINUX
from cyb3rhq_testing.tools.file import get_list_of_content_yml
from cyb3rhq_testing.tools.services import delete_dbs
...
def test_sync_agent_groups(restart_cyb3rhq_daemon, test_case, create_groups, pre_insert_agents_into_group,
                           clean_databases):
    '''
    ...
    parameters:
        - restart_cyb3rhq_daemon:
            type: fixture
            brief: Truncate ossec.log and restart Cyb3rhq.
        - test_case:
            type: fixture
