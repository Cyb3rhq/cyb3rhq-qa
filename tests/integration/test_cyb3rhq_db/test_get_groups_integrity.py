...
from cyb3rhq_testing.cyb3rhq_db import query_wdb, insert_agent_in_db, remove_agent
...
def test_get_groups_integrity(test_case, create_groups):
    '''
    description: Check that every input message using the 'get-groups-integrity' command in cyb3rhq-db socket generates
