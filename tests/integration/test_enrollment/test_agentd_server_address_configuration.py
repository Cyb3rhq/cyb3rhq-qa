...
references:
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/client.html#address
...
from cyb3rhq_testing.agent import callback_connected_to_manager_ip, callback_invalid_server_address, \
                                callback_could_not_resolve_hostname, CLIENT_KEYS_PATH
from cyb3rhq_testing.tools import HOSTS_FILE_PATH
...
from cyb3rhq_testing.tools.monitoring import DEFAULT_WAIT_FILE_TIMEOUT
...
daemons_handler_configuration = {'daemons': ['cyb3rhq-agentd'], 'ignore_errors': True}
...
parameters = [
    ...
    {'SERVER_ADDRESS': 'cyb3rhq-manager-ipv4'},         # Resolve hostname, valid IP, unable to connect (IPv4)
    {'SERVER_ADDRESS': 'cyb3rhq-manager-ipv6'},         # Resolve hostname, valid IP, unable to connect (IPv6 compressed)
]
...
metadata = [
    ...
    {'server_address': 'cyb3rhq-manager-ipv4', 'host_ip': '127.0.0.1', 'expected_connection': True},
    {'server_address': 'cyb3rhq-manager-ipv6', 'host_ip': '::1', 'expected_connection': True, 'ipv6': True}
]
