...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/ruleset/cdb-list.html
...
def configure_cdbs_list(get_configuration, request):
    ...
    Restarting Cyb3rhq is not needed for applying the configuration, it is optional.
    """

    # cdb configuration for testing
    cdb_dir = os.path.join(CYB3RHQ_PATH, get_configuration['cdb_dir'])
    ...
    rule_dir = os.path.join(CYB3RHQ_PATH, get_configuration['rule_dir'])
