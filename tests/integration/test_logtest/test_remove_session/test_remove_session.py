...
from cyb3rhq_testing.tools.monitoring import close_sockets
...
def test_remove_session(restart_required_logtest_daemons, wait_for_logtest_startup, connect_to_sockets_function,
                        test_case: list):
    '''
    description: Check if 'cyb3rhq-logtest' correctly detects and removes the sessions under pre-defined scenarios.
