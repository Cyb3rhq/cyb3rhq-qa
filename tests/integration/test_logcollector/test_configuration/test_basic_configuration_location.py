...
from cyb3rhq_testing.logcollector import WINDOWS_CHANNEL_LIST, callback_eventchannel_bad_format, \
...
def test_configuration_location(get_configuration, configure_environment, restart_logcollector):
    ...
    if cyb3rhq_component == 'cyb3rhq-manager':
        ...
        if sys.platform == 'win32':
            assert check_if_process_is_running('cyb3rhq-agent.exe') == True
            ...
            check_if_process_is_running('cyb3rhq-logcollector')
