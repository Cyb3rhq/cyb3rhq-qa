...
def check_configuration_reconnect_time_valid():
    """Check if Cyb3rhq module correctly runs and analyzes the desired eventchannel.
...
def check_configuration_reconnect_time_invalid(cfg):
    """Check if Cyb3rhq fails due to a invalid reconnect time attribute configuration value.
