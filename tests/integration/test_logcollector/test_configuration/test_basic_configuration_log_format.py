...
default_log_format_configuration = 'cyb3rhq_basic_configuration.yaml'
multiple_logcollector_configuration = 'cyb3rhq_duplicated_macos_configuration.yaml'
no_location_defined_configuration = 'cyb3rhq_no_defined_location_macos_configuration.yaml'
...
macos_tcases = [{'LOCATION': 'macos', 'LOG_FORMAT': 'macos', 'VALID_VALUE': True},
                ...
                {'LOCATION1': 'macos', 'LOG_FORMAT1': 'macos', 'LOCATION2': 'macos', 'LOG_FORMAT2': 'macos',
                 'VALID_VALUE': True, 'CONFIGURATION': 'cyb3rhq_duplicated_macos_configuration.yaml'},
                {'LOG_FORMAT': 'macos', 'VALID_VALUE': True,
                 'CONFIGURATION': 'cyb3rhq_no_defined_location_macos_configuration.yaml'}
                ]
...
configurations = load_cyb3rhq_configurations(configurations_path_default, __name__,
...
configurations += load_cyb3rhq_configurations(configurations_path_multiple_logcollector, __name__,
...
configurations += load_cyb3rhq_configurations(configurations_path_no_location, __name__,
