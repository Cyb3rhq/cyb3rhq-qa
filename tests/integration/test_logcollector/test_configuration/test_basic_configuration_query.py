...
cyb3rhq_configuration = 'cyb3rhq_basic_configuration_query_macos.yaml'
...
if sys.platform != 'win32' and sys.platform != 'darwin':
    ...
    if sys.platform == 'darwin':
        ...
        cyb3rhq_configuration = 'cyb3rhq_basic_configuration_query_windows.yaml'
...
configurations_path = os.path.join(test_data_path, cyb3rhq_configuration)
...
def test_configuration_query_valid(get_configuration, configure_environment, restart_logcollector):
    '''
    description: Check if the 'cyb3rhq-logcollector' daemon starts properly when the 'query' tag is used.
    ...
    input_description: A configuration template (test_basic_configuration_query_macos and
                       ...
                       (cyb3rhq_basic_configuration_query_macos.yaml and cyb3rhq_basic_configuration_query_windows.yaml).
                       Those templates are combined with different test cases defined in the module. Those include
                       configuration settings for the 'cyb3rhq-logcollector' daemon.
