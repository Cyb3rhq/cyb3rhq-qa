...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/localfile.html#query
...
configurations_path_query = os.path.join(test_data_path, 'cyb3rhq_macos_format_query.yaml')
configurations_path_query_type = os.path.join(test_data_path, 'cyb3rhq_macos_format_query_type.yaml')
configurations_path_query_level = os.path.join(test_data_path, 'cyb3rhq_macos_format_query_level.yaml')
configurations_path_query_type_level = os.path.join(test_data_path, 'cyb3rhq_macos_format_query_type_level.yaml')
...
macos_log_list = [
    ...
    },
    {
        ...
        'level': 'default',
        'type': 'log',
        'subsystem': 'testing.cyb3rhqagent.macos',
    ...
    },
    {
        ...
        'level': 'debug',
        'type': 'log',
        'subsystem': 'testing.cyb3rhqagent.example',
        'category': 'category'
    },
    {
        'program_name': 'customlogdebug',
...
configurations = load_cyb3rhq_configurations(configurations_path_query_type_level, __name__,
                                           params=parameters_query_type_level, metadata=metadata_query_type_level)
configurations += load_cyb3rhq_configurations(configurations_path_query_type, __name__,
                                            params=parameters_query_type, metadata=metadata_query_type)
configurations += load_cyb3rhq_configurations(configurations_path_query_level, __name__,
                                            params=parameters_query_level, metadata=metadata_query_level)
configurations += load_cyb3rhq_configurations(configurations_path_query, __name__,
...
def test_macos_format_query(configure_local_internal_options_module, restart_logcollector_required_daemons_package,
    ...
    description: Check if the 'query' option together with its attributes ('type' and 'level') is properly used
                 by the 'cyb3rhq-logcollector' when using the macOS unified logging system (ULS) events. For this
    ...
    parameters:
        ...
        - restart_logcollector_required_daemons_package:
            type: fixture
            brief: Restart the 'cyb3rhq-agentd', 'cyb3rhq-logcollector', and 'cyb3rhq-modulesd' daemons.
        - get_configuration:
            type: fixture
    ...
    input_description: Configuration templates (test_macos_format_query) are contained in external YAML files
                       (cyb3rhq_macos_format_query*.yaml, ). Those templates are combined with different
