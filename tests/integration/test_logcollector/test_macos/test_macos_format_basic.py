...
macos_log_messages = [
    {
        ...
        'type': 'log',
        'level': 'error',
        'subsystem': 'testing.cyb3rhq-agent.macos',
        'category': 'category',
        'id': 'os_log_command'
    },
    {
...
def test_macos_format_basic(restart_logcollector_required_daemons_package, get_configuration, configure_environment,
    ...
    '''
    description: Check if the 'cyb3rhq-logcollector' gathers properly macOS unified logging system (ULS) events.
    ...
    parameters:
        ...
        - restart_logcollector_function:
            type: fixture
            brief: Restart the 'cyb3rhq-logcollector' daemon on each test case.
    ...
    input_description: A configuration template (test_macos_format_basic) is contained in an external YAML file
                       (cyb3rhq_macos_format_basic.yaml). That template is combined with two test cases defined
