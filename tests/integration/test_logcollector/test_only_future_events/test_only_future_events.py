...
log_test_path = os.path.join(temp_dir, 'cyb3rhq-testing', 'test.log')
...
def test_only_future_events(configuration, metadata, set_cyb3rhq_configuration,
                            configure_local_internal_options_module, setup_log_monitor, get_files_list,
                            create_file_structure_module, restart_cyb3rhq_daemon_function):
    '''
