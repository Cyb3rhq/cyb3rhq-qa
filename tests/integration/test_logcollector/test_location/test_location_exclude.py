...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/localfile.html#exclude
...
parameters = [
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', '*.log')},
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt')},
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', '*test*'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', '*.log')},
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*')},
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*')},
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', '*test*'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*')},
    ...
    {'LOCATION': os.path.join(temp_dir, 'cyb3rhq-testing', '*'), 'LOG_FORMAT': 'syslog',
     'EXCLUDE': os.path.join(temp_dir, 'cyb3rhq-testing', '*')}
]

metadata = [
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', 'test.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test1.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test2.log')],
     'log_format': 'syslog', 'exclude': os.path.join(temp_dir, 'cyb3rhq-testing', '*.log'),
     'expected_matches': [os.path.join(temp_dir, 'cyb3rhq-testing', 'test.txt')],
     'description': 'Testing right wildcard, left exclude'},
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', '2test.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test.txt')],
     'log_format': 'syslog', 'exclude': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt'),
     'expected_matches': ['none'],
     'description': 'Testing left wildcard, left exclude'},
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', '*test*'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', '2test2.log')],
     'log_format': 'syslog', 'exclude': os.path.join(temp_dir, 'cyb3rhq-testing', '*.log'),
     'expected_matches': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.txt')],
     'description': 'Testing right and left wildcard, left exclude'},
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', 'test1.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test1.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test2.log')],
     'log_format': 'syslog', 'exclude':os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'),
     'expected_matches': ['none'],
    ...
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', '*test.txt'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test.txt'),
               ...
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test.txt')],
     'log_format': 'syslog', 'exclude': os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'),
     'expected_matches': [os.path.join(temp_dir, 'cyb3rhq-testing', ' 1test.txt'),
                          os.path.join(temp_dir, 'cyb3rhq-testing', '2test.txt')],
    ...
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', '*test*'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.txt'),
               os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', '2test2.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test2.txt')],
     'log_format': 'syslog', 'exclude':os.path.join(temp_dir, 'cyb3rhq-testing', 'test*'),
     'expected_matches': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.txt'),
                          os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.log'),
                          os.path.join(temp_dir, 'cyb3rhq-testing', '2test2.log')],
    ...
    {'location': os.path.join(temp_dir, 'cyb3rhq-testing', '*'),
     'files': [os.path.join(temp_dir, 'cyb3rhq-testing', '1test1.txt'),
               ...
               os.path.join(temp_dir, 'cyb3rhq-testing', '2test2.log'),
               os.path.join(temp_dir, 'cyb3rhq-testing', 'test2.txt')],
     'log_format': 'syslog', 'exclude': os.path.join(temp_dir, 'cyb3rhq-testing', '*'),
     'expected_matches': ['none'],
...
def test_location_exclude(get_files_list, create_file_structure_module, get_configuration, configure_environment,
    ...
    '''
    description: Check if the 'cyb3rhq-logcollector' excludes the files specified in the 'exclude' tag. For this
    ...
    for file_location in sorted(files):
        ...
        if match:
            ...
            cyb3rhq_log_monitor.start(timeout=logcollector.LOG_COLLECTOR_GLOBAL_TIMEOUT,
