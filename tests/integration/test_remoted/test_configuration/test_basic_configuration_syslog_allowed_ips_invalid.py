...
configurations = load_cyb3rhq_configurations(configurations_path, "test_allowed_ips_invalid",
...
def test_allowed_ips_invalid(get_configuration, configure_environment, restart_remoted):
    '''
    description: Check that 'cyb3rhq-remoted' fails when 'allowed-ips' has invalid values.
