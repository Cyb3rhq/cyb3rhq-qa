...
brief: The 'cyb3rhq-remoted' program is the server side daemon that communicates with the agents.
       Specifically, this test will check that 'cyb3rhq-remoted' fails when syslog connection is used
...
def test_allowed_denied_ips_syslog(get_configuration, configure_environment, restart_remoted):
    '''
    description: Check that 'cyb3rhq-remoted' fails when 'allowed-ips' is not provided but syslog connection is used.
