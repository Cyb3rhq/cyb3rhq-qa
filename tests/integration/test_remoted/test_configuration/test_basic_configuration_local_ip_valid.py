...
configurations = load_cyb3rhq_configurations(configurations_path, "test_basic_configuration_local_ip",
...
def test_local_ip_valid(get_configuration, configure_environment, restart_remoted, wait_for_remoted_start_log):
    '''
    description: Check if 'cyb3rhq-remoted' can set 'local_ip' using different IPs without errors.
