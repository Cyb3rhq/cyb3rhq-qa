...
configurations = load_cyb3rhq_configurations(configurations_path, "test_basic_configuration_connection",
...
def test_invalid_connection(get_configuration, configure_environment, restart_remoted):
    '''
    description: Check if `cyb3rhq-remoted` fails using invalid 'connection' values and shows the expected error message
