...
configurations = load_cyb3rhq_configurations(configurations_path, "test_basic_configuration_local_ip", params=parameters,
                                           metadata=metadata)
...
def test_local_ip_invalid(get_configuration, configure_environment, restart_remoted):
    '''
    description: Check if 'cyb3rhq-remoted' fails when 'local_ip' is configured with invalid values.
