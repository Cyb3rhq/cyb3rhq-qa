...
configurations_single = load_cyb3rhq_configurations(configurations_path, "test_basic_configuration_allowed_denied_ips",
                                                  params=parameters_single, metadata=metadata_single)
configurations_multiple = load_cyb3rhq_configurations(configurations_path,
...
def test_allowed_denied_ips_syslog(get_configuration, configure_environment, restart_remoted, wait_for_remoted_start_log):
    ...
    expected_output:
        ...
        - Cyb3rhq remoted didn't start as expected.
    ...
    if 'allowed-ips2' in cfg:
        pytest.xfail(f"Expected error: https://github.com/cyb3rhq/cyb3rhq/issues/11643")
