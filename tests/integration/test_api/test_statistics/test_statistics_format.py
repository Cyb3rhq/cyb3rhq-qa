...
from cyb3rhq_testing.api import make_api_call
from cyb3rhq_testing.tools import agent_simulator as ag
from cyb3rhq_testing.tools.configuration import load_configuration_template, get_test_cases_data
from cyb3rhq_testing.tools.file import read_json_file
...
def test_manager_statistics_format(configuration, metadata, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
                                   get_api_details, restart_cyb3rhq_daemon_function):
    """
    ...
    parameters:
        ...
        - restart_cyb3rhq_daemon_function:
            type: fixture
            brief: Restart the cyb3rhq service and truncate cyb3rhq logs.
...
def test_agent_statistics_format(metadata, restart_cyb3rhq_daemon_function, get_api_details):
    """
    description: Check if the statistics returned by the API have the expected format.
