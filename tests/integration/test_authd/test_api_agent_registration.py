...
references:
    - https://documentation.cyb3rhq.com/current/user-manual/registering/restful-api-registration.html
...
from cyb3rhq_testing.tools import API_LOG_FILE_PATH, CLIENT_KEYS_PATH
...
def test_agentd_server_configuration(truncate_api_log, clean_registered_agents, wait_for_start_module,
    ...
    '''
    description:
        Checks `cyb3rhq-api` responds correctly to agent registration requests. Also, ensure client.keys is update
