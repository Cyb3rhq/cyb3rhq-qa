...
from cyb3rhq_testing.modules.aws.cloudwatch_utils import log_stream_exists
from cyb3rhq_testing.modules.aws.s3_utils import file_exists
...
def test_remove_from_bucket(
    configuration, metadata, mark_cases_as_skipped, upload_and_delete_file_to_s3, load_cyb3rhq_basic_configuration,
...
def test_remove_log_stream(
    configuration, metadata, create_log_stream, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
    clean_aws_services_db, configure_local_internal_options_function, truncate_monitored_files, restart_cyb3rhq_function,
    file_monitoring
):
    """
