...
import pytest
from cyb3rhq_testing import T_20, TEMPLATE_DIR, TEST_CASES_DIR, global_parameters
...
def test_bucket_and_service_missing(
    configuration, metadata, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
