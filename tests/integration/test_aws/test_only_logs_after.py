...
import pytest
from cyb3rhq_testing import T_10, T_20, TEMPLATE_DIR, TEST_CASES_DIR, global_parameters
from cyb3rhq_testing.modules import aws as cons
from cyb3rhq_testing.modules.aws import ONLY_LOGS_AFTER_PARAM, event_monitor, local_internal_options  # noqa: F401
from cyb3rhq_testing.modules.aws.cli_utils import call_aws_module
from cyb3rhq_testing.modules.aws.cloudwatch_utils import (
    create_log_events,
    create_log_stream,
)
from cyb3rhq_testing.modules.aws.db_utils import (
...
from cyb3rhq_testing.modules.aws.s3_utils import get_last_file_key, upload_file
...
def test_bucket_without_only_logs_after(
    configuration, metadata, upload_and_delete_file_to_s3, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
    clean_s3_cloudtrail_db, configure_local_internal_options_function, truncate_monitored_files, restart_cyb3rhq_function,
    file_monitoring
):
    """
...
def test_service_without_only_logs_after(
    configuration, metadata, create_log_stream_in_existent_group, load_cyb3rhq_basic_configuration,
    set_cyb3rhq_configuration, clean_aws_services_db, configure_local_internal_options_function, truncate_monitored_files,
...
def test_bucket_multiple_calls(
    metadata, clean_s3_cloudtrail_db, load_cyb3rhq_basic_configuration, restart_cyb3rhq_function, delete_file_from_s3
):
    """
...
def test_cloudwatch_multiple_calls(
    metadata, clean_aws_services_db, load_cyb3rhq_basic_configuration, restart_cyb3rhq_function, delete_log_stream
):
    """
    description: Call the AWS module multiple times with different only_logs_after values.
    test_phases:
