...
def test_integration_no_option_tag(configuration, metadata, set_cyb3rhq_configuration, truncate_monitored_files,
    ...
    evm.get_message_sent(integration='Slack', file_monitor=cyb3rhq_monitor)
...
def test_slack_options(configuration, metadata, set_cyb3rhq_configuration, truncate_monitored_files,
                       configure_local_internal_options_module, restart_cyb3rhq_daemon_function,
                       wait_for_start_module):
    '''
    ...
    if not metadata['sends_message']:
        ...
        message = evm.get_message_sent(integration='Slack', file_monitor=cyb3rhq_monitor)
