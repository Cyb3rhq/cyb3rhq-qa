...
monitored_sockets_params = [('cyb3rhq-db', mitm_wdb, True), ('cyb3rhq-analysisd', None, None)]
...
def test_validate_rare_socket_responses(configure_sockets_environment, connect_to_sockets_module,
    ...
    '''
    description: Validate each response from the 'cyb3rhq-analysisd' daemon socket
                 to the 'cyb3rhq-db' daemon socket using rare 'syscheck' events
