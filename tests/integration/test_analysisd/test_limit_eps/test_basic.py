...
def test_enabled(configuration, metadata, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
...
def test_disabled(configuration, metadata, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
                  configure_local_internal_options_function, truncate_monitored_files, restart_cyb3rhq_daemon_function):
    """
