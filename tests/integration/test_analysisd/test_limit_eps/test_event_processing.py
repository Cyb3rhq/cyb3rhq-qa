...
from cyb3rhq_testing import ARCHIVES_LOG_PATH
from cyb3rhq_testing.modules.analysisd import event_monitor as evm
from cyb3rhq_testing.tools import file
from cyb3rhq_testing.modules.analysisd import QUEUE_EVENTS_SIZE, ANALYSISD_ONE_THREAD_CONFIG
from cyb3rhq_testing.scripts.syslog_simulator import DEFAULT_MESSAGE_SIZE
...
local_internal_options = {'cyb3rhq_modules.debug': '2', 'monitord.rotate_log': '0', 'analysisd.state_interval': '1'}
...
t4_local_internal_options = {'cyb3rhq_modules.debug': '2', 'monitord.rotate_log': '0', 'analysisd.state_interval': '1'}
...
def test_limitation(configuration, metadata, load_cyb3rhq_basic_configuration, set_cyb3rhq_configuration,
                    configure_local_internal_options_function, truncate_monitored_files, restart_cyb3rhq_daemon_function):
    """
    ...
    # Check that cyb3rhq-manager is processing syslog events
    ...
    # Check that the cyb3rhq-manager is receiving events but it is not processing them due to the limitation
...
def test_queueing_events_after_limitation(configuration, metadata, load_cyb3rhq_basic_configuration,
                                          set_cyb3rhq_configuration, configure_local_internal_options_function,
                                          truncate_monitored_files, restart_cyb3rhq_daemon_function):
    """
...
def test_dropping_events_when_queue_is_full(configuration, metadata, load_cyb3rhq_basic_configuration,
                                            set_cyb3rhq_configuration, configure_local_internal_options_function,
                                            truncate_monitored_files, restart_cyb3rhq_daemon_function):
    """
...
def test_event_processing_in_order_single_thread(configuration, metadata, load_cyb3rhq_basic_configuration,
                                                 set_cyb3rhq_configuration, configure_local_internal_options_function,
                                                 truncate_event_logs, restart_cyb3rhq_daemon_function):
    """
...
def test_event_processing_in_order_multi_thread(configuration, metadata, load_cyb3rhq_basic_configuration,
                                                set_cyb3rhq_configuration, configure_local_internal_options_function,
                                                truncate_event_logs, restart_cyb3rhq_daemon_function):
    """
    description: Check that events are processed in order according to the position within the queue, and
