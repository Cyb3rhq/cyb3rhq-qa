...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_disabled_sync_conf.yaml')
...
def test_sync_disabled(get_configuration, configure_environment, install_audit, restart_syscheckd):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon uses the value of the 'enabled' tag to disable
    ...
    input_description: A test case (sync_disabled) is contained in external YAML file (cyb3rhq_disabled_sync_conf.yaml)
