...
from cyb3rhq_testing.fim import LOG_FILE_PATH, callback_detect_synchronization, generate_params
...
from cyb3rhq_testing.tools.time import TimeMachine, time_to_timedelta
...
def test_sync_interval(get_configuration, configure_environment, restart_syscheckd, wait_for_fim_start):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon performs the file synchronization at the intervals
    ...
    input_description: A test case (sync_interval) is contained in external YAML file (cyb3rhq_conf.yaml) which
