...
import pytest
from cyb3rhq_testing import global_parameters, LOG_FILE_PATH, REGULAR, DATA
...
from cyb3rhq_testing.modules.fim import (TEST_DIR_1, WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, TEST_DIRECTORIES,
                                       YAML_CONF_SYNC_WIN32, TEST_REGISTRIES, SYNCHRONIZATION_ENABLED,
                                       SYNCHRONIZATION_REGISTRY_ENABLED)
from cyb3rhq_testing.modules.fim.event_monitor import CB_INTEGRITY_CONTROL_MESSAGE
