...
from cyb3rhq_testing.modules.fim import (registry_parser, KEY_WOW64_64KEY, WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY,
...
from cyb3rhq_testing.modules.fim.event_monitor import (CB_REGISTRY_LIMIT_VALUE, ERR_MSG_REGISTRY_LIMIT_VALUES,
...
def test_registry_limit_values(configure_local_internal_options_module, get_configuration, configure_environment,
                               restart_syscheckd):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects the value of the 'registries' tag, which corresponds to
    ...
    registry_limit_value = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
    ...
    key_entries = cyb3rhq_log_monitor.start(timeout=monitor_timeout,
