...
from cyb3rhq_testing.modules.fim import (registry_parser, KEY_WOW64_64KEY, REG_SZ, KEY_ALL_ACCESS, RegOpenKeyEx,
...
from cyb3rhq_testing.modules.fim.event_monitor import (CB_REGISTRY_LIMIT_CAPACITY, CB_COUNT_REGISTRY_VALUE_ENTRIES,
...
from cyb3rhq_testing.modules.fim.utils import generate_params, modify_registry_value, create_registry
...
def test_registry_value_limit_full(configure_local_internal_options_module, get_configuration, configure_environment,
                                   restart_syscheckd):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon generates proper events while the FIM database is in
    ...
    input_description: A test case (fim_registry_limit) is contained in external YAML file (cyb3rhq_conf.yaml)
    ...
    tags:
        - scheduled
    '''
    database_state = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
    ...
    cyb3rhq_log_monitor.start(timeout=monitor_timeout,
    ...
    value_entries = cyb3rhq_log_monitor.start(timeout=monitor_timeout,
