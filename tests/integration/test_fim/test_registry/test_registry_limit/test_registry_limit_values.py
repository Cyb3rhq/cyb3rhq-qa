...
from cyb3rhq_testing.fim import (generate_params, modify_registry_value, create_registry)
from cyb3rhq_testing.modules.fim import FIM_DEFAULT_LOCAL_INTERNAL_OPTIONS as local_internal_options
from cyb3rhq_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, registry_parser, KEY_WOW64_64KEY,
                                       REG_SZ, KEY_ALL_ACCESS, RegOpenKeyEx, RegCloseKey)
from cyb3rhq_testing.modules.fim.event_monitor import (CB_REGISTRY_LIMIT_VALUE, ERR_MSG_FIM_REGISTRY_VALUE_ENTRIES,
