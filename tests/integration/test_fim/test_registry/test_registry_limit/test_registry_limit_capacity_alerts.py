...
from cyb3rhq_testing.modules.fim.event_monitor import (callback_detect_end_scan, CB_REGISTRY_LIMIT_CAPACITY,
...
from cyb3rhq_testing.modules.fim.utils import (generate_params, modify_registry_value, wait_for_scheduled_scan,
...
def test_registry_limit_capacity_alert(percentage, get_configuration, configure_local_internal_options_module,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon generates events for different capacity thresholds limits when
    ...
    if percentage >= 80:  # Percentages 80 and 90
        ...
        wait_for_scheduled_scan(wait_for_scan=True, interval=scan_delay, monitor=cyb3rhq_log_monitor)
    ...
    value_entries = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
