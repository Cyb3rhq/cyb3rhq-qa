...
from cyb3rhq_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, MONITORED_KEY_2, registry_parser,
                                       KEY_WOW64_64KEY, KEY_ALL_ACCESS, RegOpenKeyEx, RegCloseKey)
from cyb3rhq_testing.modules.fim.event_monitor import (CB_REGISTRY_LIMIT_CAPACITY, ERR_MSG_DATABASE_FULL_ALERT,
...
from cyb3rhq_testing.modules.fim.utils import generate_params, create_registry
...
def test_registry_key_limit_full(configure_local_internal_options_module, get_configuration, configure_environment,
    ...
    cyb3rhq_log_monitor.start(timeout=monitor_timeout, error_message=ERR_MSG_DATABASE_FULL_COULD_NOT_INSERT,
                            callback=generate_monitoring_callback(CB_DATABASE_FULL_COULD_NOT_INSERT_KEY))

    key_entries = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
