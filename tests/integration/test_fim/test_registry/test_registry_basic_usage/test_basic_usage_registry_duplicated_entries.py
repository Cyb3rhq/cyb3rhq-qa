...
from cyb3rhq_testing.tools.utils import get_version
...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_conf_duplicated_registry.yaml')
...
# Test
@pytest.mark.skipif(get_version() != 'v4.2.3', reason="This test fails by cyb3rhq/cyb3rhq#6797, It was fixed on v4.2.3")
