...
from cyb3rhq_testing.fim import LOG_FILE_PATH, generate_params, callback_detect_event, \
...
def test_wait_until_baseline(key, subkey, arch, value_type, content, get_configuration,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects registry events generated after the 'baseline'.
