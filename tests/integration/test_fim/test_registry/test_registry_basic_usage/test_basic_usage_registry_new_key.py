...
def test_new_key(get_configuration, configure_environment, restart_syscheckd, wait_for_fim_start):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon generates events from a new monitored key after
    ...
    registry_value_cud(key, sub_key_1, cyb3rhq_log_monitor, arch=arch,
