...
from cyb3rhq_testing.modules.fim.utils import (registry_value_create, registry_value_update, registry_value_delete,
...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_registry_diff_size_limit_values.yaml')
