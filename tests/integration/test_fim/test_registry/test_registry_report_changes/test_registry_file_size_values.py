...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/syscheck.html#file-size
...
from cyb3rhq_testing.fim import (LOG_FILE_PATH, registry_value_create, registry_value_update, registry_value_delete,
                               KEY_WOW64_32KEY, KEY_WOW64_64KEY, generate_params, calculate_registry_diff_paths,
                               create_values_content)
from cyb3rhq_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, MONITORED_KEY_2,
...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_registry_file_size_values.yaml')
...
def test_file_size_values(key, subkey, arch, value_name, size, get_configuration, configure_environment,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon limits the size of the monitored value to generate
