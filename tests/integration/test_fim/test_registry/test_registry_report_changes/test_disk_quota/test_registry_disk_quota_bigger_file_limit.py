...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/syscheck.html#disk-quota
...
from cyb3rhq_testing.modules.fim.event_monitor import ERR_MSG_CONTENT_CHANGES_EMPTY, ERR_MSG_CONTENT_CHANGES_NOT_EMPTY
from cyb3rhq_testing.modules.fim.utils import (generate_params, calculate_registry_diff_paths, registry_value_create,
...
def test_disk_quota_values(key, subkey, arch, value_name, size, get_configuration, configure_environment,
    ...
    """
    description: Check if the 'cyb3rhq-syscheckd' daemon sets the 'disk_quota' limit to be equal to the
    ...
    input_description: A test case (test_limits) is contained in external YAML file
                       (cyb3rhq_registry_report_changes_limits_quota.yaml) which includes configuration
