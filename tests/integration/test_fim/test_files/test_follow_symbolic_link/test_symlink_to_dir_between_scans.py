...
def test_symlink_to_dir_between_scans(tags_to_apply, get_configuration, configure_environment, restart_syscheckd,
                                      wait_for_fim_start):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects events when a monitored symlink is replaced by
    ...
    input_description: A test case (replace_with_directory) is contained in external YAML file (cyb3rhq_conf.yaml)
