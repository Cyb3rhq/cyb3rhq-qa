...
def test_audit_rules_removed_after_change_link(replaced_target, new_target, file_name, tags_to_apply,
    ...
    input_description: A test case (check_audit_removed_rules) is contained in external YAML file (cyb3rhq_conf.yaml)
    ...
    ev = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout, callback=fim.callback_detect_event,
    ...
    fim.wait_for_audit(True, cyb3rhq_log_monitor)
