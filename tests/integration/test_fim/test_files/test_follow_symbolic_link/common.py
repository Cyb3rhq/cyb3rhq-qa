...
from cyb3rhq_testing.fim import create_file, REGULAR, SYMLINK, callback_symlink_scan_ended, change_internal_options
...
def debug_sym_check(func):
    """Decorator to see how long it's taking cyb3rhq log monitor to detect the sym_check event"""
