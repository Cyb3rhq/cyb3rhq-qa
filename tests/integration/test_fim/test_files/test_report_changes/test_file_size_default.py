...
from cyb3rhq_testing.tools.file import create_file, modify_file_content
...
from cyb3rhq_testing.modules.fim.event_monitor import (callback_detect_event, CB_FILE_SIZE_LIMIT_REACHED,
...
def test_file_size_default(filename, folder, get_configuration, configure_environment,
    ...
    input_description: A test case (ossec_conf_diff_default) is contained in external YAML
                       file (cyb3rhq_conf.yaml) which includes configuration settings for
