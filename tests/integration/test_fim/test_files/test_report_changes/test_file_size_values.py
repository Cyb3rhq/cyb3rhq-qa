...
from cyb3rhq_testing.modules.fim.event_monitor import (CB_FILE_SIZE_LIMIT_REACHED, CB_DIFF_FOLDER_DELETED,
...
def test_file_size_values(filename, folder, get_configuration, configure_environment,
    ...
    input_description: A test case (ossec_conf_diff) is contained in external YAML file (cyb3rhq_conf.yaml)
