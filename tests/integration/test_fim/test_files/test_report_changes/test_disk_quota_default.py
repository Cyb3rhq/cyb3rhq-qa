...
from cyb3rhq_testing.modules.fim.event_monitor import CB_DISK_QUOTA_LIMIT_CONFIGURED_VALUE, ERR_MSG_DISK_QUOTA_LIMIT
...
def test_disk_quota_default(get_configuration, configure_environment,
    ...
    disk_quota_value = cyb3rhq_log_monitor.start(
