...
from cyb3rhq_testing import global_parameters, LOG_FILE_PATH, REGULAR, T_20
from cyb3rhq_testing.modules.fim import TEST_DIR_1
from cyb3rhq_testing.modules.fim import FIM_DEFAULT_LOCAL_INTERNAL_OPTIONS as local_internal_options
from cyb3rhq_testing.modules.fim.event_monitor import (callback_detect_event, get_fim_event,
                                                     callback_detect_file_more_changes)
from cyb3rhq_testing.modules.fim.utils import create_file
...
def test_large_changes(configuration, metadata, set_cyb3rhq_configuration, configure_local_internal_options_function,
    ...
    cyb3rhq_log_monitor.start(timeout=T_20, callback=callback_detect_event,
    ...
    if metadata['has_more_changes']:
        ...
        event = cyb3rhq_log_monitor.start(timeout=T_20, callback=callback_detect_event,
                                        error_message="Did not receive the expected FIM event").result()
