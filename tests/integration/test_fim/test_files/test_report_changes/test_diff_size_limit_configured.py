...
from cyb3rhq_testing import global_parameters, DATA, LOG_FILE_PATH
...
from cyb3rhq_testing.modules.fim import (TEST_DIR_1, REPORT_CHANGES, TEST_DIRECTORIES, DIFF_LIMIT_VALUE, FILE_SIZE_LIMIT,
                                       DIFF_SIZE_LIMIT, DISK_QUOTA_ENABLED, DISK_QUOTA_LIMIT, FILE_SIZE_ENABLED)
from cyb3rhq_testing.modules.fim.event_monitor import (CB_MAXIMUM_FILE_SIZE, ERR_MSG_MAXIMUM_FILE_SIZE,
...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_conf_diff.yaml')
...
def test_diff_size_limit_configured(configure_local_internal_options_module, get_configuration, configure_environment,
    ...
    input_description: A test case (ossec_conf_diff_size_limit) is contained in external YAML
                       file (cyb3rhq_conf_diff.yaml) which includes configuration settings for
    ...
    diff_size_value = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
