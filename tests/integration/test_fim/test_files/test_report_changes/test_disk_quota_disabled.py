...
from cyb3rhq_testing.modules.fim.event_monitor import callback_disk_quota_limit_reached
from cyb3rhq_testing.modules.fim.utils import generate_params, create_file
...
def test_disk_quota_disabled(filename, folder, size, get_configuration, configure_environment,
    ...
    with pytest.raises(TimeoutError):
        cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout, callback=callback_disk_quota_limit_reached)
