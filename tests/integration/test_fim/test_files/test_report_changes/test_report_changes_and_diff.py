...
references:
    ...
    - https://documentation.cyb3rhq.com/current/user-manual/reference/ossec-conf/syscheck.html#nodiff
...
def test_reports_file_and_nodiff(configuration, metadata, set_cyb3rhq_configuration,
    ...
    input_description: A test case (ossec_conf_report) is contained in external YAML file (cyb3rhq_conf.yaml)
    ...
    cyb3rhq_log_monitor = FileMonitor(LOG_FILE_PATH)
    regular_file_cud(folder, cyb3rhq_log_monitor, file_list=file_list, min_timeout=T_20,
