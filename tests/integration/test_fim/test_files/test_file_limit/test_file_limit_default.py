...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts
       ...
       number of files monitored by the 'cyb3rhq-syscheckd' daemon is set to default when
...
def test_file_limit_default(configure_local_internal_options_module, get_configuration, configure_environment,
                            restart_syscheckd):
    '''
    description: Check if the maximum number of files monitored by the 'cyb3rhq-syscheckd' daemon is set to default
    ...
    input_description: A test case (file_limit_default) is contained in external YAML file (cyb3rhq_conf.yaml)
