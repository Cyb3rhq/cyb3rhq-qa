...
import pytest
from cyb3rhq_testing import LOG_FILE_PATH, T_10, T_60
...
from cyb3rhq_testing.modules.fim.event_monitor import check_fim_event, CB_FIM_PATH_CONVERTED
...
def test_windows_system_monitoring(configuration, metadata, test_folders, set_cyb3rhq_configuration,
    ...
    regular_file_cud(folder, cyb3rhq_log_monitor, file_list=file_list, min_timeout=T_60, triggers_event=True,
                     escaped=True)
