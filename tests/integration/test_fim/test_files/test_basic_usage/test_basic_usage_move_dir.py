...
def extra_configuration_before_yield():
    """Create subdirs before restarting Cyb3rhq."""
...
def test_move_dir(source_folder, target_folder, subdir, tags_to_apply, triggers_delete_event, triggers_add_event,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects 'added' and 'deleted' events when moving a subdirectory
    ...
    if mode == 'whodata' and subdir[-1] == os.path.sep and sys.platform == 'linux':
        pytest.xfail('Xfailing due to issue: https://github.com/cyb3rhq/cyb3rhq/issues/4720')
    elif mode == 'whodata' and subdir[-1] == os.path.sep and sys.platform == 'win32':
        pytest.xfail('Xfailing due to issue: https://github.com/cyb3rhq/cyb3rhq/issues/6089')
    ...
    events = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
