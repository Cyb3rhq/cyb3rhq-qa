...
from cyb3rhq_testing import logger, LOG_FILE_PATH
...
from cyb3rhq_testing.tools.file import write_file
from cyb3rhq_testing.modules.fim import TEST_DIR_1, REALTIME_MODE, WHODATA_MODE
from cyb3rhq_testing.modules.fim import FIM_DEFAULT_LOCAL_INTERNAL_OPTIONS as local_internal_options
from cyb3rhq_testing.modules.fim.event_monitor import (ERR_MSG_MULTIPLE_FILES_CREATION, callback_integrity_message,
...
def test_max_eps(configure_local_internal_options_module, get_configuration, configure_environment, restart_cyb3rhq):
    '''
    ...
    input_description: A test case (max_eps) is contained in external YAML file (cyb3rhq_conf.yaml) which
    ...
    result = cyb3rhq_log_monitor.start(timeout=TIMEOUT,
