...
from cyb3rhq_testing import global_parameters, REGULAR, LOG_FILE_PATH
...
from cyb3rhq_testing.modules.fim.event_monitor import callback_detect_file_added_event, callback_restricted
...
def test_restrict(folder, filename, mode, content, triggers_event, tags_to_apply, get_configuration,
    ...
    if triggers_event:
        ...
        while True:
            ignored_file = cyb3rhq_log_monitor.start(timeout=global_parameters.default_timeout,
