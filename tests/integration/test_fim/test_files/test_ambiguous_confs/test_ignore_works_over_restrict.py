...
import pytest
from cyb3rhq_testing import LOG_FILE_PATH, REGULAR, T_10
from cyb3rhq_testing.tools import PREFIX
from cyb3rhq_testing.modules.fim.event_monitor import CB_IGNORING_DUE_TO_SREGEX, CB_IGNORING_DUE_TO_PATTERN
...
def test_ignore_works_over_restrict(configuration, metadata, set_cyb3rhq_configuration, test_folders,
    ...
    matching_log = cyb3rhq_log_monitor.start(timeout=T_10, accum_results=2, callback=generate_monitoring_callback(regex),
