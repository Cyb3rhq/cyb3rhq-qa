...
configurations_path = os.path.join(test_data_path, 'cyb3rhq_conf_dir.yaml')
...
def test_tag_directories(directory, get_configuration, truncate_monitored_files, put_env_variables,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects CUD events ('added', 'modified', and 'deleted')
    ...
    input_description: A test case (ossec_conf) is contained in external YAML file (cyb3rhq_conf_dir.yaml) which
    ...
    regular_file_cud(directory, cyb3rhq_log_monitor, file_list=["testing_env_variables"],
                     min_timeout=T_20)
