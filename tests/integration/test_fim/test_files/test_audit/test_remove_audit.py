...
from cyb3rhq_testing.modules.fim.event_monitor import callback_audit_cannot_start
...
def test_move_folders_to_realtime(configuration, metadata, set_cyb3rhq_configuration, create_monitored_folders,
    ...
    test_phases:
        - setup:
            ...
            - Restart cyb3rhq-syscheck daemon to apply configuration changes.
        - test:
    ...
    cyb3rhq_log_monitor.start(timeout=20, callback=callback_audit_cannot_start,
