...
import pytest
from cyb3rhq_testing import T_30, LOG_FILE_PATH
...
def test_tags(folder, name, content,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon generates the tags required for each event
    ...
    input_description: A test case is contained in external YAML file (cyb3rhq_conf.yaml) which
                       includes configuration settings for the 'cyb3rhq-syscheckd' daemon and,
    ...
    regular_file_cud(folder, cyb3rhq_log_monitor, file_list=files, min_timeout=T_30,
