...
def test_scan_day(tags_to_apply,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' performs a scan on the day of the week specified in
    ...
    input_description: A test case (scan_day) is contained in external YAML file (cyb3rhq_conf.yaml) which
