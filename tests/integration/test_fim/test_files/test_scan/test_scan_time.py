...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts when these
       files are modified. Specifically, these tests will check if the 'cyb3rhq-syscheckd' daemon runs
...
def test_scan_time(tags_to_apply,
    ...
    '''
    description: Check if the 'cyb3rhq-syscheckd' performs a scan at the time of day specified in
    ...
    input_description: A test case (scan_time) is contained in external YAML file (cyb3rhq_conf.yaml) which
