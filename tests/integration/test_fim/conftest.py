...
from cyb3rhq_testing import (global_parameters, LOG_FILE_PATH, REGULAR, CYB3RHQ_SERVICES_START, CYB3RHQ_SERVICES_STOP,
                           CYB3RHQ_LOG_MONITOR)
from cyb3rhq_testing.tools.services import control_service
from cyb3rhq_testing.tools.monitoring import FileMonitor
from cyb3rhq_testing.tools.file import truncate_file, delete_path_recursively, create_file
from cyb3rhq_testing.tools.local_actions import run_local_command_returning_output
from cyb3rhq_testing.modules.fim import (WINDOWS_HKEY_LOCAL_MACHINE, MONITORED_KEY, SYNC_INTERVAL_VALUE, KEY_WOW64_64KEY,
