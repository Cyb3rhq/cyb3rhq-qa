...
from cyb3rhq_testing.tools import monitoring
...
CLIENT_KEYS_PATH = os.path.join(CYB3RHQ_PATH, folder, 'client.keys')  # for unix add 'etc'
...
AGENT_AUTH_BINARY_PATH = '/var/ossec/bin/agent-auth' if platform.system() == 'Linux' else \
    os.path.join(CYB3RHQ_PATH, 'agent-auth.exe')
