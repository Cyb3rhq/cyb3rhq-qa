...
class CustomLogger:
    def __init__(self, name, file_path='/tmp/cyb3rhq_api_simulator.log', foreground=False, tag='Main',
                 level=logging.INFO):
...
class APISimulator:
    def __init__(self, host, port, protocol='https', frequency=60, user='cyb3rhq-wui', password='cyb3rhq-wui',
                 external_logger=None, request_percentage=0, request_template=None):
        self.host = host
        self.port = port
        self.protocol = protocol
        self.frequency = frequency
        self.logger = external_logger if external_logger else logging.getLogger('cyb3rhq-api-requester')
        self.user = user
