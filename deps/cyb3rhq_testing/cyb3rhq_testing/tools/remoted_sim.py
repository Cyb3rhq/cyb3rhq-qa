...
from cyb3rhq_testing.tools.monitoring import Queue


class Cipher:
    """Algorithm to perform encryption/decryption of manager-agent secure messages:
    https://documentation.cyb3rhq.com/current/development/message-format.html#secure-message-format.
    """
...
class RemotedSimulator:
    ...
    def __init__(self, server_address='127.0.0.1', remoted_port=1514, protocol='udp', mode='REJECT',
                 client_keys=CYB3RHQ_PATH + '/etc/client.keys', start_on_init=True, rcv_msg_limit=0):
    ...
    def cyb3rhq_padding(self, compressed_sec_message):
        """Add the Cyb3rhq custom padding to each sec_message sent."""
        padding = 8
    ...
    def create_sec_message(self, message, crypto_method, binary_data=None):
        ...
        # Padding
        padded_sec_message = self.cyb3rhq_padding(compressed_sec_message)
        # Encrypt
