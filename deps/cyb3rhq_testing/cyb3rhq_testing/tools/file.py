...
from cyb3rhq_testing import logger, REGULAR, SYMLINK, HARDLINK
...
def bind_unix_socket(socket_path, protocol='TCP'):
    ...
    By default it is assigned owner and group cyb3rhq and permissions 660.
    ...
    if not os.path.exists(socket_path) and sys.platform != 'win32':
        ...
        set_file_owner_and_group(socket_path, 'cyb3rhq', 'cyb3rhq')
