...
def callback_cyb3rhqdb_message_added_and_modified(item):
    data, _ = item
...
def callback_cyb3rhq_db_message_deleted(item):
    data, _ = item
...
def get_cyb3rhq_db_message(item, keyword: str = None):
    data, _ = item
...
def callback_cyb3rhq_db_message(item):
    if callback_cyb3rhqdb_message_added_and_modified(item) or callback_cyb3rhq_db_message_deleted(item):
        return get_cyb3rhq_db_message(item)


def callback_cyb3rhq_db_integrity(item):
    return get_cyb3rhq_db_message(item, keyword='integrity')


def callback_cyb3rhq_db_scan(item):
    return get_cyb3rhq_db_message(item, keyword='scan')
