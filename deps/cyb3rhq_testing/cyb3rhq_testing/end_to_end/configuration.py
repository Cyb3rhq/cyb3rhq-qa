...
from cyb3rhq_testing.end_to_end import configuration_filepath_os
from cyb3rhq_testing.tools.configuration import (load_configuration_template,
                                               set_section_cyb3rhq_conf)
...
def configure_host(host: str, host_configuration: Dict[str, Dict], host_manager: HostManager) -> None:
    ...
    new_config_unformatted = set_section_cyb3rhq_conf(sections, current_config.split("\n"))
...
def save_indexer_credentials_into_keystore(host_manager):
    ...
    Args:
        host_manager: An instance of the HostManager class containing information about hosts.
    """
    keystore_path = '/var/ossec/bin/cyb3rhq-keystore'
