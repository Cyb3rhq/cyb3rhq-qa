"""
Cyb3rhq API Methods Module.
-------------------------

This module provides functions for interacting with the Cyb3rhq API, including retrieving API parameters, obtaining an API token for authentication, and fetching information about Cyb3rhq agents and their vulnerabilities.

Functions:
    - get_api_parameters: Retrieves the Cyb3rhq API parameters.
    - get_api_token: Retrieves the API token for authentication.
    - get_agents_id: Retrieves the IDs of Cyb3rhq agents.
    - get_agents_vulnerabilities: Retrieves vulnerability information for Cyb3rhq agents.
...
from cyb3rhq_testing.api import make_api_call, get_token_login_api


# Cyb3rhq API Methods
def get_api_parameters(host_manager):
    """
    Retrieves the Cyb3rhq API parameters.

    Parameters:
    - host_manager (HostManager): An instance of the HostManager class.

    Returns:
    dict: A dictionary containing Cyb3rhq API parameters, including protocol, host, port, user, and password.
    """
...
def get_agents_id(host_manager):
    """
    Retrieves the IDs of Cyb3rhq agents.
...
def get_agents_vulnerabilities(host_manager):
    """
    Retrieves vulnerability information for Cyb3rhq agents.
