...
from cyb3rhq_testing.tools.services import check_if_process_is_running


def check_if_modulesd_is_running():
    """Check if modulesd daemon is running"""
    assert check_if_process_is_running('cyb3rhq-modulesd'), 'cyb3rhq-modulesd is not running. It may have crashed'
