...
from cyb3rhq_testing.qa_ctl.run_tests.test_result import TestResult
...
from cyb3rhq_testing.qa_ctl.run_tests.test import Test
...
class Pytest(Test):
    ...
    def __init__(self, tests_result_path, tests_path, tests_run_dir, qa_ctl_configuration,
                 ...
                 component=None, system='linux', cyb3rhq_install_path=None, ansible_admin_user=None):
        ...
        self.hosts = hosts
        self.cyb3rhq_install_path = cyb3rhq_install_path
        self.ansible_admin_user = ansible_admin_user
        self.tests_result_path = os.path.join(gettempdir(), 'cyb3rhq_qa_ctl') if tests_result_path is None \
