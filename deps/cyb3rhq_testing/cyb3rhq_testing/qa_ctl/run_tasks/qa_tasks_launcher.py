...
from cyb3rhq_testing.tools.file import download_text_file, remove_file
            ...
            if 'playbooks' in task_data:
                for playbook_data in task_data['playbooks']:
                    if 'local_path' in playbook_data:
                        ...
                        playbook_file_path = os.path.join(gettempdir(), 'cyb3rhq_qa_ctl', playbook_file_name)
    ...
    def run(self):
        ...
        try:
            if sys.platform == 'win32':
                ...
                tmp_path = os.path.join(gettempdir(), 'cyb3rhq_qa_ctl')
                ...
                # Copy the local playbooks to the cyb3rhq qa-ctl path, that is shared with the container through a volume
                    ...
                    if 'playbooks' in task_data:
                        for playbook_data in task_data['playbooks']:
                            if 'local_path' in playbook_data:
                                ...
                                playbook_data['local_path'] = f"/cyb3rhq_qa_ctl/{playbook_file}"
