...
from cyb3rhq_testing.qa_ctl.provisioning.ansible.ansible_output import AnsibleOutput
...
from cyb3rhq_testing.tools.exceptions import AnsibleException
...
class AnsibleRunner:
    ...
    def __init__(self, ansible_inventory_path, ansible_playbook_path,
                 private_data_dir=join(gettempdir(), 'cyb3rhq_qa_ctl'), output=False, task_id=None):
