...
from cyb3rhq_testing.qa_ctl.deployment.docker_wrapper import DockerWrapper
from cyb3rhq_testing.qa_ctl.deployment.vagrant_wrapper import VagrantWrapper
...
class QAInfraestructure:
    ...
    """
    DOCKER_NETWORK_NAME = 'cyb3rhq_net'
