...
import cyb3rhq_testing
from cyb3rhq_testing.db_interface import global_db
from cyb3rhq_testing.db_interface import agent_db
from cyb3rhq_testing.tools.services import control_service
from cyb3rhq_testing.tools import client_keys
...
SYSTEM_DATA = {
    ...
    'ALAS_2023': {'hostname': 'alas2023', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2023',
                  ...
                  'version': 'Cyb3rhq v4.4.0', 'os_release': '', 'checksum': '1693284466493410477', 'name': 'alas2023',
                  'ip': '127.0.0.1', 'register_ip': '127.0.0.1', 'internal_key': '', 'os_arch': 'x86_64',
    ...
    'BOOKWORM': {'hostname': 'bookworm', 'architecture': 'x86_64', 'os_name': 'Debian GNU/Linux', 'os_version': '12',
                 ...
                 'os_platform': 'debian', 'sysname': 'Linux', 'release': '6.1.0-10-amd64', 'version': 'Cyb3rhq v4.5.0',
    ...
    'AlmaLinux-8': {'hostname': 'localhost', 'architecture': 'x64', 'os_name': 'AlmaLinux', 'os_version': '8',
                    ...
                    'version': 'Cyb3rhq v4.4.0', 'os_release': '', 'checksum': '1652388661375945607',
...
def create_mocked_agent(name='centos8-agent', ip='127.0.0.1', register_ip='127.0.0.1', internal_key='',
    ...
    control_service('restart', daemon='cyb3rhq-db')
...
def delete_mocked_agent(agent_id):
    ...
    remove_file(os.path.join(cyb3rhq_testing.QUEUE_DB_PATH, f"{agent_id}.db"))
