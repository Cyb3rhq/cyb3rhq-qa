...
from cyb3rhq_testing.tools.sources.report_generator import ReportGenerator


def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description='Cyb3rhq data sources generator',
