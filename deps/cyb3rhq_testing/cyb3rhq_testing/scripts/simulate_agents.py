...
from cyb3rhq_testing.modules.syscollector import SYSCOLLECTOR_DELTA_EVENT_TYPES
...
def parse_custom_labels(labels):
    """Parse the cyb3rhq labels from string list to dict.
    Args:
...
def main():
    ...
    arg_parser.add_argument('-v', '--version', metavar='<version>', dest='version',
                            type=str, required=False, default='4.2.0', help='Agent cyb3rhq version')
    ...
    arg_parser.add_argument('-l', '--labels', dest='labels', required=False, type=str, nargs='+',
                            action='store', default=None, help='Cyb3rhq agent labels.')
