...
"""
Version: 1.0
Tool documentation: https://github.com/cyb3rhq/cyb3rhq-qa/wiki/Stress-results-comparator-tool
...
MANAGER_DAEMON_LIST = ['remoted', 'analysisd', 'cyb3rhq-db', 'cyb3rhq-authd', 'clusterd', 'monitord',
...
def process_dataframes(parameters):
    ...
    filtered_dataframes = [dataframe[dataframe['Daemon'] == f"cyb3rhq-{parameters.selected_daemon}"] for dataframe
                           in dataframes]
