...
from cyb3rhq_testing.tools.performance.binary import ClusterLogParser, APILogParser
...
def get_script_arguments():
    ...
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Cyb3rhq log parser",
