...
import yaml
from cyb3rhq_testing.tools.api_simulator import CustomLogger, APISimulator


def get_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]",
                                     description="Cyb3rhq API load simulator",
    ...
    parser.add_argument('-l', '--log-path', dest='log_path', action='store', default='/tmp/cyb3rhq_api_simulator.log',
...
def main():
    ...
    main_logger = CustomLogger('cyb3rhq_api_simulator', file_path=options.log_path,
