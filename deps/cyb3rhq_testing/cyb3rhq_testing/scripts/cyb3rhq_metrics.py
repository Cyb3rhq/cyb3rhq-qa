...
from cyb3rhq_testing.tools.performance.binary import Monitor, logger
...
def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Cyb3rhq processes metrics",
...
def main():
    ...
    logging.basicConfig(filename=join(METRICS_FOLDER, 'cyb3rhq-metrics.log'), filemode='a',
