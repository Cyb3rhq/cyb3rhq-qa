...
from cyb3rhq_testing.qa_docs.lib.config import Mode
from cyb3rhq_testing.qa_docs.lib.code_parser import CodeParser
from cyb3rhq_testing.qa_docs.lib.utils import clean_folder
from cyb3rhq_testing.qa_docs import QADOCS_LOGGER
from cyb3rhq_testing.tools.logging import Logging
from cyb3rhq_testing.tools.exceptions import QAValueError
from cyb3rhq_testing.qa_docs.lib.utils import get_file_path_recursively
...
class DocGenerator:
    ...
    The included paths are generated using the types and modules from the cyb3rhq-qa framework.
    ...
    def print_module_info(self, module):
        ...
        """
        relative_path = re.sub(r'.*cyb3rhq-qa\/', '', self.module_path)
