...
git clone https://github.com/cyb3rhq/cyb3rhq-qa --depth=1 -b ${BRANCH} &> /dev/null
...
/usr/local/bin/qa-docs -p /tests/cyb3rhq-qa/tests --validate-parameters ${CMD}
...
echo "Running /usr/local/bin/qa-docs -p /tests/cyb3rhq-qa/tests ${CMD}"
/usr/local/bin/qa-docs -p /tests/cyb3rhq-qa/tests ${CMD}
