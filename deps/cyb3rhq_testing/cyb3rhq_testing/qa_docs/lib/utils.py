...
def qa_docs_docker_run(qa_branch, command, output_path):
    ...
    Having this functionality helps the people that do not have ElasticSearch and(or) cyb3rhq framework to generate
    the documentation of the tests.

    Args:
        qa_branch (str): Cyb3rhq qa branch that will be used as tests input.
    ...
    docker_image_name = 'cyb3rhq/qa-docs'
