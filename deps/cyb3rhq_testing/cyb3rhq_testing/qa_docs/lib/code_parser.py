...
from cyb3rhq_testing.qa_docs.lib.pytest_wrap import PytestWrap
from cyb3rhq_testing.qa_docs.lib.utils import remove_inexistent
...
class CodeParser:
    ...
    def check_predefined_values(self, doc, doc_type, path):
        ...
        https://github.com/cyb3rhq/cyb3rhq-qa/wiki/Documenting-tests-using-the-qadocs-schema#pre-defined-values.
                ...
                for value in doc_field:
                    if value not in self.conf.predefined_values[field]:
                        CodeParser.LOGGER.error(f"{field} field in {path} {doc_type} documentation block has "
                                                ...
                                                "If you want more info, visit https://github.com/cyb3rhq/cyb3rhq-qa/wiki/"
    ...
    def parse_module(self, path, id, group_id):
        ...
        if module_doc:
            ...
            module_doc['path'] = re.sub(r'.*cyb3rhq-qa\/', '', path)
