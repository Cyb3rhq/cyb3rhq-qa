...
from cyb3rhq_testing import CVE_DB_PATH
from cyb3rhq_testing.db_interface import make_sqlite_query, get_sqlite_query_result
from cyb3rhq_testing.modules import vulnerability_detector as vd
...
def insert_vulnerability(cveid='CVE-000', target='RHEL7', target_minor='',
                         ...
                         reference='https://github.com/cyb3rhq/cyb3rhq-qa', target_v='REDHAT', cvss='10.000000',
                         cvss_vector='AV:N/AC:L/Au:N/C:C/I:C/A:C', rationale='Cyb3rhq integration test vulnerability',
                         cvss3='', bugzilla_reference='https://github.com/cyb3rhq/cyb3rhq-qa', cwe='WVE-000 -> WVE-001',
