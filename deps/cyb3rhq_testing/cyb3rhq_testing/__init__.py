...
if sys.platform == 'win32':
    ...
    SYSCOLLECTOR_DB_PATH = os.path.join(CYB3RHQ_PATH, 'queue', 'syscollector', 'db', 'local.db')
else:
...
CYB3RHQ_CONF_PATH = os.path.join(CYB3RHQ_PATH, 'etc', 'ossec.conf')
CYB3RHQ_LOGS_PATH = os.path.join(CYB3RHQ_PATH, 'logs')
CLIENT_KEYS_PATH = os.path.join(CYB3RHQ_PATH, 'etc' if platform.system() == 'Linux' else '', 'client.keys')
...
ALERTS_JSON_PATH = os.path.join(CYB3RHQ_PATH, 'logs', 'alerts', 'alerts.json')
ARCHIVES_LOG_PATH = os.path.join(CYB3RHQ_PATH, 'logs', 'archives', 'archives.log')
ARCHIVES_JSON_PATH = os.path.join(CYB3RHQ_PATH, 'logs', 'archives', 'archives.json')
...
CYB3RHQ_TESTING_PATH = os.path.dirname(os.path.abspath(__file__))
CIS_RULESET_PATH = os.path.join(CYB3RHQ_PATH, 'ruleset', 'sca')
CYB3RHQ_TESTING_DATA_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data')
DEFAULT_AUTHD_PASS_PATH = os.path.join(CYB3RHQ_PATH, 'etc', 'authd.pass')
...
# Paths
SYSLOG_SIMULATOR = os.path.join(CYB3RHQ_TESTING_PATH, 'scripts', 'syslog_simulator.py')
ANALYSISD_STATE = os.path.join(CYB3RHQ_PATH, 'var', 'run', 'cyb3rhq-analysisd.state')
...
logger = logging.getLogger('cyb3rhq_testing')
