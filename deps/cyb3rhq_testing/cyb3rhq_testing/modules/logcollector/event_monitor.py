...
import sys
import pytest
from cyb3rhq_testing import T_30, T_10, LOG_FILE_PATH
from cyb3rhq_testing.modules.logcollector import LOG_COLLECTOR_PREFIX, ERR_MSG_UNEXPECTED_IGNORE_EVENT
