import sys
from cyb3rhq_testing.tools.monitoring import LOG_COLLECTOR_DETECTOR_PREFIX, AGENT_DETECTOR_PREFIX


# Variables
LOG_COLLECTOR_PREFIX = AGENT_DETECTOR_PREFIX if sys.platform == 'win32' else LOG_COLLECTOR_DETECTOR_PREFIX
WINDOWS_AGENT_PREFIX = r'.*cyb3rhq-agent.*'
MAILD_PREFIX = r'.*cyb3rhq-maild.*'
