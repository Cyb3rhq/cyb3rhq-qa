...
# Yaml Configuration
YAML_CONF_REGISTRY_RESPONSE = 'cyb3rhq_conf_registry_responses_win32.yaml'
YAML_CONF_SYNC_WIN32 = 'cyb3rhq_sync_conf_win32.yaml'
YAML_CONF_MAX_EPS_SYNC = 'cyb3rhq_sync_conf_max_eps.yaml'
