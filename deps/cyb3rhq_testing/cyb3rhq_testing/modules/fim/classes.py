...
from cyb3rhq_testing import global_parameters, logger, CYB3RHQ_TESTING_DATA_PATH
from cyb3rhq_testing.modules.fim import REQUIRED_ATTRIBUTES, REQUIRED_REG_KEY_ATTRIBUTES, REQUIRED_REG_VALUE_ATTRIBUTES, CHECK_GROUP
...
def validate_event(event, checks=None, mode=None):
    ...
    with open(os.path.join(CYB3RHQ_TESTING_DATA_PATH, json_file), 'r') as f:
        schema = json.load(f)
