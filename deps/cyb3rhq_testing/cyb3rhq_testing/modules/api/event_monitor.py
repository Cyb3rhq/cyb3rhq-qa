...
from cyb3rhq_testing.modules import api
from cyb3rhq_testing.api import API_LOGIN_ENDPOINT
...
def check_api_login_request(log_monitor=None, timeout=fw.T_5, user='cyb3rhq', host='127.0.0.1',
                            file_to_monitor=fw.API_LOG_FILE_PATH):
