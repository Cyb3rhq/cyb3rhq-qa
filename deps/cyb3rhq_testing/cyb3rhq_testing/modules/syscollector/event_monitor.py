...
from cyb3rhq_testing.event_monitor import check_event


# Define the log messages prefix
SYSCOLLECTOR_PREFIX = '.+cyb3rhq-modulesd:syscollector.+'
...
def check_config(disabled='no', interval=3600, scan_on_start='yes', hardware='yes', os='yes', ports='yes',
    ...
    Args:
        ...
        ports_all (str): Make Cyb3rhq only scans listening ports.
